...
object FakeLevelsWithActivitiesData {
    ...
    fun get(count: Int, activitiesPerLevelCount: Int = 3): List<Activity/*LevelWithActivitiesEntity*/> =
        mutableListOf<Activity/*LevelWithActivitiesEntity*/>().apply {
            repeat(count) {
                        ...
                        repeat(activitiesPerLevelCount) { index ->
                            ...
                            add(
                                Activity(
                                    ...
                                    lockedIcon = null,
                                    level = levelValue,
                                    levelTitle = "Level $levelValue",
                                    levelDescription = "Sample description for Level $levelValue",
                                    levelState = ChallengeActivity.State.entries.random().value,
